/*
	Matreshka v1.1.0-alpha.1 (2015-08-13)
				...
				changeModel = function() {
					...
					if (Model) {
						_this.mediateItem(function(item) {
							return !item || !item.isMK || !item.instanceOf(Model)
				...
				var _this = this,
					...
					renderOne = function(item) {
						return item && item.isMK && _this.renderIfPossible && container && !evt.dontRender
							&& (_this.itemRenderer || item && item.renderer) && _this._renderOne(item, evt);
					},
					node,
					i,
					item,
