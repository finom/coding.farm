...
f=0;f<b.length;f++)d.mediate(a,b[f],function(b,d){var f;return d instanceof c?(e.call(a,d,b),f=d):f=new c(b),f});return a},linkProps:function(a,b,c,e,f,g){if(!a||"object"!=typeof a)return a;j(a),c="string"==typeof c?c.split(/\s/):c,g=g||{};var h,k,l,m,n,o=function(f){var j=[],o=f._protect=f._protect||{};if(f.fromDependency=!0,!(b+a[i].id in o)){if("object"==typeof c[0])for(m=0;m<c.length;m+=2)for(h=c[m],l="string"==typeof c[m+1]?c[m+1].split(/\s/):c[m+1],n=0;n<l.length;n++)j.push(h[l[n]]);else for(m=0;m<c.length;m++)k=c[m],h=a,j.push(h[k]);o[b+a[i].id]=1,d._defineSpecial(a,b,g.hideProperty),d.set(a,b,e.apply(a,j),f)}};if(e=e||function(a){return a},"object"==typeof c[0])for(m=0;m<c.length;m+=2)for(h=j(c[m]),l="string"==typeof c[m+1]?c[m+1].split(/\s/):c[m+1],n=0;n<l.length;n++)d._defineSpecial(h,l[n]),d._fastAddListener(h,"_rundependencies:"+l[n],o);else for(m=0;m<c.length;m++)k=c[m],h=a,d._defineSpecial(h,k),d._fastAddListener(h,"_rundependencies:"+k,o);return f!==!1&&o.call("object"==typeof c[0]?c[0]:a,{
