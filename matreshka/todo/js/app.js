...
$( function() {
	// We're creating custom binder that will switch bound element visibility depending on property value using [jQuery.fn.toggle](http://api.jquery.com/toggle/) method.
	// ```js
	...
	// Look at [todos.js](todos.html) and [todos.js](todos.html)
});
